...
export function GetDeadLetterTopicsForTopic(arg1:string):Promise<Array<admin.TopicInfo>>;
...
export function GetSubscriptionsUsingTopicAsDeadLetter(arg1:string):Promise<Array<admin.SubscriptionInfo>>;
...
export function GetTopicSubscriptions(arg1:string):Promise<Array<admin.SubscriptionInfo>>;
